        ...
        {loading ? (
          <div className="flex items-center justify-center h-full">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">{t('usageDashboard.loading')}</p>
            </div>
          </div>
        ) : error ? (
          <div className="flex items-center justify-center h-full">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <Card className="p-4 shimmer-hover">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs text-muted-foreground">{t('usageDashboard.cost')}/{t('usageDashboard.sessions')}</p>
                    <p className="text-2xl font-bold mt-1">
                      {formatCurrency(
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              <TabsList className="grid w-full grid-cols-5">
                ...
                <TabsTrigger value="models">{t('usageDashboard.costBreakdown')}</TabsTrigger>
                <TabsTrigger value="projects">{t('usageDashboard.projectName')}</TabsTrigger>
                <TabsTrigger value="sessions">{t('usageDashboard.sessions')}</TabsTrigger>
                <TabsTrigger value="timeline">{t('usageDashboard.sessionBreakdown')}</TabsTrigger>
              </TabsList>
              ...
              <TabsContent value="models">
                <Card className="p-6">
                  <h3 className="text-sm font-semibold mb-4">{t('usageDashboard.costBreakdown')}</h3>
                    ...
                    {stats.by_model.map((model) => (
                      <div key={model.model} className="space-y-2">
                        ...
                        <div className="grid grid-cols-4 gap-2 text-xs">
                          <div>
                            <span className="text-muted-foreground">{t('usageDashboard.inputTokens')}: </span>
                            <span className="font-medium">{formatTokens(model.input_tokens)}</span>
                          </div>
                          <div>
                            <span className="text-muted-foreground">{t('usageDashboard.outputTokens')}: </span>
              ...
              <TabsContent value="projects">
                <Card className="p-6">
                  <h3 className="text-sm font-semibold mb-4">{t('usageDashboard.projectName')}</h3>
                  <div className="space-y-3">
                    {stats.by_project.map((project) => (
                      <div key={project.project_path} className="flex items-center justify-between py-2 border-b border-border last:border-0">
                        ...
                        <div className="text-right">
                          ...
                          <p className="text-xs text-muted-foreground">
                            {formatCurrency(project.total_cost / project.session_count)}/{t('usageDashboard.sessions')}
                          </p>
                        </div>
                      </div>
                    ))}
              ...
              <TabsContent value="sessions">
                  <Card className="p-6">
                      <h3 className="text-sm font-semibold mb-4">{t('usageDashboard.sessions')}</h3>
                      <div className="space-y-3">
              ...
              <TabsContent value="timeline">
                <Card className="p-6">
                  <h3 className="text-sm font-semibold mb-6 flex items-center space-x-2">
                    ...
                    <span>{t('usageDashboard.sessionDate')}</span>
                  </h3>
